...
//Here, code is similar to that of MainActivity.
// Only major difference is use of signInWithEmailAndPassword() method in place of createUserWithEmailAndPassword().
